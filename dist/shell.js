...
export function KatalisShell({ sections, current, business, user, signInHref, signOutUrl, contactsHref, contentId = "katalis-content" }) {
    ...
    async function signOut() {
        ...
        try {
            if (signOutUrl)
                await signOutOfSuite(signOutUrl);
